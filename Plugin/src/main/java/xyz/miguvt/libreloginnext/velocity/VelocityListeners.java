...
import xyz.miguvt.libreloginnext.common.listener.AuthenticListeners;
...
public class VelocityListeners extends AuthenticListeners<VelocityLibreLoginNext, Player, RegisteredServer> {
    ...
    public VelocityListeners(VelocityLibreLoginNext plugin) {
        super(plugin);
    }
    ...
    public void onPreLogin(PreLoginEvent event) {
        ...
        if (plugin.floodgateEnabled()) {
            ...
            try {
                ...
                e.printStackTrace();
                event.setResult(PreLoginEvent.PreLoginComponentResult.denied(Component.text("Internal LibreLoginNext error")));
                return;
            }
        }
