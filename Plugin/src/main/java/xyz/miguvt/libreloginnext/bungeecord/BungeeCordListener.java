...
public class BungeeCordListener extends AuthenticListeners<BungeeCordLibreLoginNext, ProxiedPlayer, ServerInfo> implements Listener {

    public BungeeCordListener(BungeeCordLibreLoginNext plugin) {
        super(plugin);
    }
