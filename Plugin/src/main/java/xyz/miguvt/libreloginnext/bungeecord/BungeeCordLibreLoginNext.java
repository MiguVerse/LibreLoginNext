...
import xyz.miguvt.libreloginnext.bungeecord.integration.BungeeNanoLimboIntegration;
...
public class BungeeCordLibreLoginNext extends AuthenticLibreLoginNext<ProxiedPlayer, ServerInfo> {
    ...
    public BungeeCordLibreLoginNext(BungeeCordBootstrap bootstrap) {
