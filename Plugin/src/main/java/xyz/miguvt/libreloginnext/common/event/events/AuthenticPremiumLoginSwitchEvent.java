...
import xyz.miguvt.libreloginnext.api.event.events.PremiumLoginSwitchEvent;
...
public class AuthenticPremiumLoginSwitchEvent<P, S> extends AuthenticPlayerBasedEvent<P, S> implements PremiumLoginSwitchEvent<P, S> {
    public AuthenticPremiumLoginSwitchEvent(@Nullable User user, P player, LibreLoginNextPlugin<P, S> plugin) {
