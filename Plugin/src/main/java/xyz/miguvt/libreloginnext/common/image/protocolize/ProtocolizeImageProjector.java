...
package xyz.miguvt.libreloginnext.common.image.protocolize;
...
import xyz.miguvt.libreloginnext.common.image.protocolize.packet.MapDataPacket;
...
public class ProtocolizeImageProjector<P, S> extends AuthenticImageProjector<P, S> implements ImageProjector<P> {
    ...
    public ProtocolizeImageProjector(AuthenticLibreLoginNext<P, S> plugin) {
        super(plugin);
    }
    ...
    public boolean canProject(P player) {
        ...
        return protocolize.protocolVersion() >= ProtocolVersions.MINECRAFT_1_13 && protocolize.protocolVersion() <= 774; // 1.21.11
    }
