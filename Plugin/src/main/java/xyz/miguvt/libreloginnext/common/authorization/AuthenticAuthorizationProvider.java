...
package xyz.miguvt.libreloginnext.common.authorization;
...
import xyz.miguvt.libreloginnext.common.event.events.AuthenticAuthenticatedEvent;
...
import xyz.miguvt.libreloginnext.api.totp.TOTPData;
...
public class AuthenticAuthorizationProvider<P, S> extends AuthenticHandler<P, S> implements AuthorizationProvider<P> {
    ...
    public AuthenticAuthorizationProvider(AuthenticLibreLoginNext<P, S> plugin) {
        super(plugin);
