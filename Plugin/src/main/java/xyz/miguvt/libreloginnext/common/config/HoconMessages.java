...
import xyz.miguvt.libreloginnext.common.config.migrate.messages.FirstMessagesMigrator;
import xyz.miguvt.libreloginnext.common.config.migrate.messages.SecondMessagesMigrator;
import xyz.miguvt.libreloginnext.common.config.migrate.messages.ThirdMessagesMigrator;
...
public class HoconMessages implements Messages {
    ...
    @Override
    public void reload(LibreLoginNextPlugin<?, ?> plugin) throws IOException, CorruptedConfigurationException {
