...
public class AuthenticMySQLDatabaseConnector extends AuthenticDatabaseConnector<SQLException, Connection> implements MySQLDatabaseConnector {
    ...
    public AuthenticMySQLDatabaseConnector(AuthenticLibreLoginNext<?, ?> plugin, String prefix) {
        super(plugin, prefix);

        this.hikariConfig = new HikariConfig();

        hikariConfig.setPoolName("LibreLoginNext MySQL Pool");
        hikariConfig.setDriverClassName("xyz.miguvt.libreloginnext.lib.mariadb.jdbc.Driver");
