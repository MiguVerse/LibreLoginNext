...
import xyz.miguvt.libreloginnext.api.authorization.AuthorizationProvider;
...
import xyz.miguvt.libreloginnext.api.event.EventProvider;
import xyz.miguvt.libreloginnext.api.event.EventTypes;
...
import xyz.miguvt.libreloginnext.api.mail.EmailHandler;
import xyz.miguvt.libreloginnext.api.premium.PremiumProvider;
 ...
 */
public interface LibreLoginNextPlugin<P, S> {
     ...
     * @param clazz   The class the connector will be registered for. (e.g. {@link xyz.miguvt.libreloginnext.api.database.connector.MySQLDatabaseConnector})
