...
package xyz.miguvt.libreloginnext.api.server;
...
public interface ServerHandler<P, S> {
     ...
     * @throws xyz.miguvt.libreloginnext.api.event.exception.EventCancelledException If lobby choose event is cancelled
